...
try:
    ...
    from Oblig3.packages.model import Transformer, TransformerMLP

except:
    from packages.preprocess import load_raw_data, filter_raw_data, pad
    from packages.preprocess import OurCONLLUDataset
    from packages.model import Transformer, TransformerMLP
...
torch.save(transformer, "transformer_mlp_benchmark.pt")
